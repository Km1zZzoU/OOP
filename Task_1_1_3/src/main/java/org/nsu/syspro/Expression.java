...
public abstract class Expression {
    ...
    /**
     * Парсит строку и возвращает математическое выражение
     * в виде объекта {@link Expression}.
     * Поддерживает числа, переменные и базовые арифметические операции:
     * сложение, вычитание, умножение и деление.
     *
     * @param str строка, содержащая математическое выражение для парсинга.
     *            Строка должна быть корректно заключена в скобки, если используются арифметические операции.
     *
     * @return объект {@link Expression}, представляющий соответствующее математическое выражение.
     */
